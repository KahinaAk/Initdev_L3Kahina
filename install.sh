...
cp "~/Téléchargements/gitignores"   "~/.initdev/gitignores"
cp "~/Téléchargements/bin"          "~/.initdev/bin"
cp "~/Téléchargements/sources"      "~/.initdev/Sources" 
cp "~/Téléchargements/licenses"     "~/.initdev/Licences"
cp "~/Téléchargements/makefiles"    "~/.initdev/Makefiles"
